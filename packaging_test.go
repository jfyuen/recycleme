...
func TestThrowAwayJSON(t *testing.T) {
	...
	expected := `{"Product":{"EAN":"7613034383808","Name":"","URL":"","ImageURL":"","WebsiteURL":"","WebsiteName":""},"ThrowAway":{"Bac à couvercle jaune":[{"Name":"Boîte carton"}],"Bac à couvercle vert":[{"Name":"Film plastique"},{"Name":"Nourriture"}]}}`
